...
contract CreateSubscription is Script{
    ...
    function createSuscriptionUsingConfig() public returns (uint64){
    ...
    function createSubscription(
        address vrfCoordinator, uint256 deployerKey
          ...
          console.log("creating suscription on chainid:",block.chainid);
          vm.startBroadcast(deployerKey);
       uint64 subId = VRFCoordinatorV2Mock(vrfCoordinator)
       .createSubscription();
          vm.stopBroadcast();  
          console.log("subid:",subId);
          console.log("please update suscriptionID in HelperConfig.s.sol");
          return subId;

    }
    function run() external returns (uint64){
        return createSuscriptionUsingConfig();
    }
}
    ...
    contract AddConsumer is Script{
        ...
        function addConsumer(
            ...
            console.log("Using vrfCoordinatir",vrfCoordinator);
